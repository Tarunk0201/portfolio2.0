...
export default function Footer() {
  return (
    <footer className="w-full py-8 text-cente dark:text-gray-300 text-black border-t border-gray-800 mt-auto relative overflow-hidden">
      ...
      <div className="flex flex-col items-center space-y-2 px-4">
        ...
        <p className="text-sm">
          ...
          <a
            href="https://github.com/adityadomle/your-repo"
            target="_blank"
            rel="noopener noreferrer"
            className="text-violet-400 hover:text-violet-300 font-medium transition-colors"
          >
